...
class networks(object):
	...
	g_bn1 = batch_norm(self.batch_size,name='g_bn1')
        g_nir1 =lrelu(g_bn1(conv2d(g_nir0,self.df_dim*4,k_h=1,k_w=1,name='g_nir1')))
	...
	g_bn3 = batch_norm(self.batch_size,name='g_bn3')
        g_nir3 =lrelu(g_bn3(conv2d(g_nir2,self.df_dim*4,name='g_nir3')))
	g_bn4 = batch_norm(self.batch_size,name='g_bn4')
        g_nir4 =lrelu(g_bn4(conv2d(g_nir2,self.df_dim*2,name='g_nir4')))
	...
	g_bn1 = batch_norm(self.batch_size,name='g_bn1')
        g_nir1 =lrelu(g_bn1(conv2d(g_nir0,self.df_dim*8,k_h=1,k_w=1,name='g_nir1'),train=False))
	g_bn2 = batch_norm(self.batch_size,name='g_bn2')
        g_nir2 =lrelu(g_bn2(conv2d(g_nir1,self.df_dim*4,name='g_nir2'),train=False))
	g_bn3 = batch_norm(self.batch_size,name='g_bn3')
        g_nir3 =lrelu(g_bn3(conv2d(g_nir2,self.df_dim*4,name='g_nir3'),train=False))
	g_bn4 = batch_norm(self.batch_size,name='g_bn4')
        g_nir4 =lrelu(g_bn4(conv2d(g_nir2,self.df_dim*2,name='g_nir4'),train=False))
        g_nir5 =conv2d(g_nir4,3,k_h=1,k_w=1,name='g_nir5')
